/**
 * @file hashtabs.h
 * @brief Public interface of <tt>hashtabs_t</tt> class
 *
 * The <tt>hashtabs_t</tt> object instantiates shallow hash-table-type associations
 * between already existing data. The user is responsible for allocating the data
 * previous to envoking <tt>hashtabs_new</tt> to generate a <tt>hashtabs_t</tt>
 * instance. The user is also responsible for deallocating the data. The routine
 * <tt>hashtabs_free</tt> only deallocates the links between data created by
 * envoking <tt>hashtabs_new</tt> and <tt>hashtabs_instert</tt>.
 *
 * The <tt>queues_t</tt> data structure of this same library is used for the
 * hash tables' buckets.
 *
 * Repetitions are not allowed, and data must be linearly ordered.
 *
 * The <tt>hashtabs_t</tt> class is implemented as an opaque pointer.
 *
 ...
 */
# ifndef INCLUDED_HASHTABS_H
# define INCLUDED_HASHTABS_H

# include <stdint.h>
# include <stdlib.h>
# include <stddef.h>

typedef struct hashtabs_t* hashtabs_t;

/**
 * @brief User provided compare function. Must provide a linear ordering of the
 * data.
 */
typedef int (*hashtabs_data_cmp)(const void*, const void*);

/**
 * @brief User provided reentrant compare function. Must provide a linear ordering
 * of the data.
 */
typedef int (*hashtabs_data_cmp_r)(const void*, const void*, void*);

/**
 * @brief User provided hash function.
 */
typedef uint64_t (*hashtabs_hash)(const void*);

/**
 * @brief User provided reentrant hash function.
 */
typedef uint64_t (*hashtabs_hash_r)(const void*, const void*);
 ...
 */
extern uint64_t hashtabs_stdhash(const void *_a, const void *_n);

/**
 * @brief Instantiates a <tt>hashtabs_t</tt> instance.
 *
 * Memory is allocated for a new <tt>hashtabs_t</tt> instance. This memory needs to
 * be freed by a call to <tt>hashtabs_free</tt>.
 *
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Both <tt>hashtabs_data_cmp</tt> and <tt>hashtabs_data_cmp_r</tt> arguments
 * are <tt>NULL</tt>.</dd>
 * <dd>Both <tt>hashtabs_hash</tt> and <tt>hashtabs_hash_r_r</tt> arguments
 * are <tt>NULL</tt>.</dd>
 * </dl>
 *
 ...
 * @param[in] hash_r User provided reentrant hashing function.
 * @param[in] n Hint for the number of elements.
 *
 * @return Instance of hash table object.
 */
extern hashtabs_t hashtabs_new(hashtabs_data_cmp cmp, hashtabs_data_cmp_r cmp_r,
                               hashtabs_hash hash, hashtabs_hash_r hash_r,
                               size_t n);

/**
 * @brief Inserts pointer to data object into hash table object.
 *
 * If a data object equal to the user provided data parameter is not present in the
 * hash table object, then a pointer is created and added to the hash table which
 * points to the data.
 *
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 *  <dd>Calling <tt>hashtabs_insert</tt> on a <tt>NULL</tt> hash table object.</dd>
 *  <dd>Bucket array remains unallocated. If it is, one needs to call
 *  <tt>hashtabs_rehash</tt>.</dd>
 * </dl>
 *
 * @param[in] t Hash table object being added to.
 * @param[in] x Pointer to data being added to hash table object.
 */
extern void hashtabs_insert(hashtabs_t t, const void *x);

/**
 * @brief Inserts pointer to data object into hash table object.
 *
 * Reentrant version of <tt>hashtabs_insert</tt>.
 *
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Calling <tt>hashtabs_insert_r</tt> on a <tt>NULL</tt> hash table
 * object.</dd>
 * <dd>Bucket array remains unallocated. If it is, one needs to call
 * <tt>hashtabs_rehash</tt>.</dd>
 * </dl>
 ...
 */
extern void hashtabs_insert_r(hashtabs_t t, const void *x,
                              const void *hash_arg, void *queue_arg);

/**
 * @brief Remove pointer to data object in hash table object (if present) equal in
 * value to the data object parameter provided by the user.
 *
 * The hash table object is searched for data equal in value to the user provided
 * data object. If found, the pointer is removed from the hash table and returned
 * to the user. If not found, <tt>NULL</tt> is returned.
 *
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Calling <tt>hashtabs_remove</tt> on <tt>NULL</tt> hash table object.</dd>
 * </dl>
 *
 ...
 */
extern void *hashtabs_remove(hashtabs_t t, const void *x);

/**
 * @brief Remove pointer to data object in hash table object (if present) equal in
 * value to the data object parameter provided by the user.
 *
 * Reentrant version of <tt>hashtabs_remove</tt>.
 *
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Calling <tt>hashtabs_remove_r</tt> on <tt>NULL</tt> hash table object.</dd>
 * </dl>
 *
 * @param[in] t Hash table object being altered.
 * @param[in] x Pointer to data object being searched for.
 ...
 * @return Pointer to data object if found. <tt>NULL</tt> otherwise.
 */
extern void *hashtabs_remove_r(hashtabs_t t, const void *x, void *queue_arg);
 ...
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Calling <tt>hashtabs_find</tt> on <tt>NULL</tt> hash table object.</dd>
 * <dd>Neither the <tt>hash_data_cmp</tt> field nor the
 * <tt>hash_data_cmp_r</tt> field is not <tt>NULL</tt>.</dd>
 * </dl>
 *
 ...
 * @return Pointer to data object if found. <tt>NULL</tt> otherwise.
 */
extern void *hashtabs_find(hashtabs_t t, const void *x);

/**
 * @brief Check if data equal to user provided data object is contained in hash
 * table object.
 *
 * Reentrant version of <tt>hashtabs_find</tt>.
 *
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Calling <tt>hashtabs_find_r</tt> on <tt>NULL</tt> hash table object.</dd>
 * <dd>Neither the <tt>hash_data_cmp</tt> field nor the
 * <tt>hash_data_cmp_r</tt> field is not <tt>NULL</tt>.</dd>
 * </dl>
 *
 ...
 * @return Pointer to data object if found. <tt>NULL</tt> otherwise.
 */
extern void *hashtabs_find_r(hashtabs_t t, const void *x, void *y);
 ...
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Calling <tt>hashtabs_map</tt> on a <tt>NULL</tt> hash table object.</dd>
 * </dl>
 *
 ...
 */
extern int hashtabs_map(hashtabs_t t, int apply(void **x));

/**
 * @brief Apply function to every member of hash table object.
 *
 * Reentrant version of <tt>hashtabs_map</tt>.
 *
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Calling <tt>hashtabs_map_r</tt> on a <tt>NULL</tt> hash table object.</dd>
 * </dl>
 *
 * @param[in] t Hash table object being acted upon.
 * @param[in] apply Function being applied to members of the hash table.
 ...
 * @return -1 if early termination. 1 if no early termination.
 */
extern int hashtabs_map_r(hashtabs_t t,
                          int apply(void **x, void *queue_arg), void *queue_arg);

/**
 * @brief Free data allocated for the shallow hash-table-type associations.
 *
 ...
 *
 * @param[in] *t Pointer to <tt>hashtabs_t</tt> object.
 */
extern void hashtabs_free(hashtabs_t *t);
 ...
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Calling <tt>hashtabs_capacity</tt> on a <tt>NULL</tt> hash table
 * object.</dd>
 * </dl>
 *
 ...
 */
extern size_t hashtabs_capacity(hashtabs_t t);
 ...
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>The <tt>hash_data_cmp_r</tt> field is <tt>NULL</tt>.</dd>
 * </dl>
 *
 ...
 * pointers as <tt>t</tt>.
 */
extern hashtabs_t hashtabs_rehash(hashtabs_t t);

/**
 * @brief Rehash array to the next prime length.
 *
 * Reentrant version of <tt>hashtabs_rehash</tt>.
 *
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>The <tt>hash_data_cmp_r</tt> field is <tt>NULL</tt>.</dd>
 ...
 * pointers as <tt>t</tt>.
 */
extern hashtabs_t hashtabs_rehash_r(hashtabs_t t, void *hash_arg, void *queue_arg);
 ...
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Calling <tt>hashtabs_size</tt> on a <tt>NULL</tt> hash table object.</dd>
 * </dl>
 *
 * @param[in] t Hash table object being checked.
 *
 ...
 */
extern size_t hashtabs_size(hashtabs_t t);
 ...
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 * <dd>Calling <tt>hashtabs_loadfactor</tt> on a <tt>NULL</tt> hash table
 * object.</dd>
 * </dl>
 *
 * @param[in] t Hash table object being checked.
 ...
 */
extern size_t hashtabs_loadfactor(hashtabs_t t);

/**
 * @brief Swap opaque pointers for hash tables.
 *
 * Swap opaque pointers for hash tables.
 *
 * <dl>
 * <dt><strong>Unchecked Runtime Errors</strong></dt>
 ...
 */
static inline
void hashtabs_swap(hashtabs_t *restrict t1, hashtabs_t *restrict t2)
{
  volatile hashtabs_t tmp = *t1;
  *t1 = *t2;
  *t2 = tmp;
}
